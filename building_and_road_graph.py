# buildings do not connect to each other, only roads are connected to buildings
# We use road_simple because we don’t necessarily need to find an exact path between building, 
# just an approximation (to a meter or so) works 
